    ...
    return (
        <div className="bg-brand-light-bg">
            <PageHero
                ...
                image="https://images.unsplash.com/photo-1579168212550-c53326b4e5ae?q=80&w=2070&auto=format=fit=crop"
            />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <AnimatedSection as="div" className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8" staggerChildren={0.1}>
                        ...
                        />
                         <ConsumableCard
                            title="...and more"
                            description="Our full catalogue includes a wider range of essential lab supplies. Contact us for specific needs or bulk ordering inquiries."
                            icon={<ConsumablesIcon className="w-8 h-8" />}
                        />
                    </AnimatedSection>
