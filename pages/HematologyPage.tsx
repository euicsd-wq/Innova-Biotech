    ...
    return (
        <div className="bg-brand-light-bg">
            <PageHero
                ...
                subtitle="Advanced hematology systems and reagents engineered for the accurate and efficient analysis of complete blood counts (CBC) and cellular differentiation."
