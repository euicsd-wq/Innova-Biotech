    ...
    return (
        <div className="bg-brand-light-bg">
            <PageHero
                ...
                subtitle="High-performance automation and analysis systems designed to enhance the efficiency, accuracy, and throughput of your laboratory workflows."
                image="https://images.unsplash.com/photo-1581091870592-a7c29a071bde?q=80&w=2070&auto=format=fit=crop"
            />
