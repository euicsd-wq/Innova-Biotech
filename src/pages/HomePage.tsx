...
import BrandLogo1 from '../components/icons/BrandLogo1';
import BrandLogo2 from '../components/icons/BrandLogo2';
import BrandLogo3 from '../components/icons/BrandLogo3';
import BrandLogo4 from '../components/icons/BrandLogo4';
import BrandLogo5 from '../components/icons/BrandLogo5';
        ...
        <section className="py-24 sm:py-32">
            <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <SectionHeader
                    ...
                    description="Each of our brands represents a commitment to quality and innovation in their respective diagnostic fields, trusted by professionals worldwide."
                />
                <div className="mt-16 grid grid-cols-2 gap-y-10 gap-x-8 items-center justify-items-center sm:grid-cols-3 lg:grid-cols-5">
                    <BrandLogo1 className="h-10 text-medium-gray hover:text-text-primary transition-colors duration-300" />
                    <BrandLogo2 className="h-10 text-medium-gray hover:text-text-primary transition-colors duration-300" />
                    <BrandLogo3 className="h-10 text-medium-gray hover:text-text-primary transition-colors duration-300" />
                    <BrandLogo4 className="h-10 text-medium-gray hover:text-text-primary transition-colors duration-300" />
                    <BrandLogo5 className="h-10 text-medium-gray hover:text-text-primary transition-colors duration-300" />
                </div>
            </AnimatedSection>
        </section>
