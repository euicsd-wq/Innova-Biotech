    ...
    return (
        <div className="bg-brand-light-bg">
            <PageHero
                ...
                description="A comprehensive portfolio of products for the efficient isolation, identification, and antimicrobial susceptibility testing of clinically significant microorganisms."
