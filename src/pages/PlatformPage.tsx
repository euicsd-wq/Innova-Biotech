    ...
    return (
        <div className="bg-brand-light-bg">
            <PageHero
                ...
                description="A revolutionary point-of-care analyzer that combines the accuracy of laboratory testing with the speed and convenience of a portable, easy-to-use device."
