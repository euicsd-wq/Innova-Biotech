...
const FeatureItem: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
    <div className="bg-brand-light-bg p-8 rounded-2xl ring-1 ring-border-color h-full">
  ...
  return (
    <div className="bg-brand-light-bg text-text-primary">
        <PageHero
            ...
            description="Our digital solutions transform diagnostic data into a strategic asset, enabling smarter clinical decisions, enhancing operational efficiency, and powering public health initiatives."
            image="https://cdn.innovadx.com/images/digital-solutions-hero.jpg"
        />
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-16 items-center">
             <div className="prose-custom prose-lg max-w-none">
                <AnimatedSection>
                    <p>
                     ...
                     <blockquote className="text-xl font-semibold text-brand-primary border-l-4 border-brand-secondary pl-6 py-2 bg-white rounded-r-lg shadow-sm">
             ...
             <AnimatedSection className="relative aspect-square">
                 <img src="https://cdn.innovadx.com/images/world-map-connections.jpg" alt="Futuristic world map with glowing data connections" className="w-full h-full object-cover rounded-2xl shadow-lg"/>
             </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose-custom prose-lg max-w-none">
            <AnimatedSection>
